...
ALTER SEQUENCE  cliente_entity_seq restart with 6;
...
ALTER SEQUENCE  locacao_entity_seq restart with 6;
...
ALTER SEQUENCE  jogo_entity_seq restart with 6;
...
ALTER SEQUENCE  plataforma_entity_seq restart with 6;
...
INSERT INTO jogo_plataforma_entity (jogo_id, plataforma_id, preco_diario) VALUES (2, 2, 24.99);
...
--ALTER SEQUENCE  jogo_plataforma_entity_seq restart with 9;

INSERT INTO item_locacao_entity (locacao_id, jogo_id, plataforma_id, dias, quantidade) VALUES (1, 1, 1, 7, 1);
INSERT INTO item_locacao_entity (locacao_id, jogo_id, plataforma_id, dias, quantidade) VALUES (1, 2, 2, 7, 1);
...
--ALTER SEQUENCE  item_locacao_entity_seq restart with 6;
